...
% modified: 2019-08-22
%
classdef orthotope < geometry.shape & math.orthotope
...
% TODO: ensure class physical_values.length
        ...
        function orthotopes_discrete = discretize( orthotopes, methods )
            ...
            % 1.) check arguments
            %--------------------------------------------------------------
            % ensure class geometry.orthotope
            if ~isa( orthotopes, 'geometry.orthotope' )
                errorStruct.message = 'orthotopes must be geometry.orthotope!';
...
% TODO: define grid subtype
                ...
                orthotopes_discrete = geometry.orthotope_grid( grids, intervals{ : } );
...
end % classdef orthotope < geometry.shape & math.orthotope
