...
% modified: 2019-09-17
%
classdef options_algorithm_spgl1 < optimization.options_algorithm
	...
	methods
        ...
        % constructor
        %------------------------------------------------------------------
        function objects = options_algorithm_spgl1( rel_RMSE, N_iterations_max, q )
        ...
        end % function objects = options_algorithm_spgl1( rel_RMSE, N_iterations_max, q )

	end % methods

end % classdef options_algorithm_spgl1 < optimization.options_algorithm
