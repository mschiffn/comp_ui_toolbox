...
% modified: 2019-10-18
%
classdef setting_tx_rnd_del < scattering.sequences.settings.controls.setting_tx
...
end % classdef setting_tx_rnd_del < scattering.sequences.settings.controls.setting_tx
