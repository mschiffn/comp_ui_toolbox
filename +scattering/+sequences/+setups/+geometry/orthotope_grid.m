...
% modified: 2019-10-17
%
classdef orthotope_grid < scattering.sequences.setups.geometry.orthotope
	...
	methods
        ...
        function objects = orthotope_grid( grids, varargin )
            ...
            objects@scattering.sequences.setups.geometry.orthotope( varargin{ : } );
...
end % classdef orthotope_grid < scattering.sequences.setups.geometry.orthotope
