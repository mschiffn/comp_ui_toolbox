%
% thermal absorption model (no thermal waves)
% author: Martin Schiffner
% date: 2016-08-25
%
classdef thermal < absorption_models.absorption_model
    ...
    methods
        ...
        % constructor
        %------------------------------------------------------------------
        function ABS_viscous = thermal( viscosity_kinematic, c_0 )
        ...
        function axis_k_tilde = compute_wavenumbers( ABS_viscous, axis_f )
            ...
            % compute complex-valued wavenumbers (\cite[312]{book:Blackstock2000})
...
end % classdef thermal < absorption_models.absorption_model
