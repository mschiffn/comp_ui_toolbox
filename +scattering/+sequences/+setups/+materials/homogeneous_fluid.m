...
classdef homogeneous_fluid
	...
	properties (SetAccess = private)
        ...
        absorption_model ( 1, 1 ) scattering.sequences.setups.materials.absorption_models.absorption_model = scattering.sequences.setups.materials.absorption_models.time_causal( 0, 0.5, 1, physical_values.meter_per_second( 1540 ), physical_values.hertz( 4e6 ), 1 ) % absorption model for the lossy homogeneous fluid
% TODO: c_avg vs c_ref? group velocity?
	...
	methods
        ...
        function objects = homogeneous_fluid( rho_0, absorption_models, c_avg )
            ...
            % property validation function ensures class scattering.sequences.setups.materials.absorption_models.absorption_model for absorption_models
