...
% modified: 2019-08-21
%
classdef L14_5_38 < scattering.sequences.setups.transducers.array_planar_regular_orthogonal
    ...
    methods
        ...
        function object = L14_5_38( varargin )
            ...
            parameters = scattering.sequences.setups.transducers.parameters_L14_5_38;
%             parameters = project( scattering.sequences.setups.transducers.parameters_L14_5_38, N_dimensions );
...
end % classdef L14_5_38 < scattering.sequences.setups.transducers.array_planar_regular_orthogonal
