...
% modified: 2019-10-17
%
classdef array_planar_regular < scattering.sequences.setups.transducers.array_planar
	...
	properties (SetAccess = private)
        ...
        face_ref ( 1, 1 ) scattering.sequences.setups.transducers.face_planar	% elementary face
	...
	methods
        ...
        function objects = array_planar_regular( faces_ref, cells_ref, N_elements_axis )
            ...
            if ~isa( faces_ref, 'scattering.sequences.setups.transducers.face_planar' )
                errorStruct.message = 'faces_ref must be scattering.sequences.setups.transducers.face_planar!';
            ...
            objects@scattering.sequences.setups.transducers.array_planar( apertures );
        ...
        function indices_linear = forward_index_transform( arrays_planar_regular, indices_axis )
            ...
            if ~isa( arrays_planar_regular, 'scattering.sequences.setups.transducers.array_planar_regular' )
                errorStruct.message = 'arrays_planar_regular must be scattering.sequences.setups.transducers.array_planar_regular!';
...
end % classdef array_planar_regular < scattering.sequences.setups.transducers.array_planar
