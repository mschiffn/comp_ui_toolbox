...
% modified: 2019-04-11
%
classdef parameters_planar_orthotope < transducers.parameters
    ...
    methods
        ...
        % constructor
        %------------------------------------------------------------------
        function objects = parameters_planar_orthotope( N_elements_axis, element_width_axis, element_kerf_axis, apodization, axial_focus_axis, str_model, str_vendor )
        ...
        end % function objects = parameters_planar_orthotope( N_elements_axis, element_width_axis, element_kerf_axis, apodization, axial_focus_axis, str_model, str_vendor )

        %------------------------------------------------------------------
        % project
        %------------------------------------------------------------------
        function parameters_planar_orthotope = project( parameters_planar_orthotope, N_dimensions )
...
end % classdef parameters_planar_orthotope < transducers.parameters
