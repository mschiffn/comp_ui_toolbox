...
% modified: 2019-06-01
%
classdef sequence_rnd_apo < scattering.sequences.sequence
	...
	methods
        ...
        function object = sequence_rnd_apo( setup, u_tx_tilde, settings_rng, interval_f )
            ...
            %--------------------------------------------------------------
            settings_tx = scattering.sequences.settings.controls.setting_tx_rnd_apo( setup, u_tx_tilde, settings_rng );
...
end % classdef sequence_rnd_apo < scattering.sequences.sequence
