    ...
    methods
        ...
        function objects = incident_wave( sequence )
            ...
            for index_object = 1:numel( sequence.settings )
                ...
                %----------------------------------------------------------
                if isa( sequence.settings( index_object ).tx_unique, 'controls.setting_tx_PW' )
                ...
                end % if isa( sequence.settings( index_object ).tx_unique, 'controls.setting_tx_PW' )
...
% TODO: move to class sequence
            ...
            % 1.) check arguments
            %--------------------------------------------------------------
            % ensure class syntheses.incident_wave
