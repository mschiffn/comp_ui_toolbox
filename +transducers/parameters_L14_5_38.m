...
classdef parameters_L14_5_38 < transducers.parameters_planar
    ...
    methods
        ...
        function objects = parameters_L14_5_38
            ...
            element_width_axis	= [279.8, 4000] * 1e-6;	% widths of physical elements along each coordinate axis (m)
            element_kerf_axis	= [25, 0] * 1e-6;       % kerfs between physical elements along each coordinate axis (m)
